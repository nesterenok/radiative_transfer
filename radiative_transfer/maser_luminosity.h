...
// Calculates the limiting luminosity, pump efficiency, pump rate, loss rate, emission measure,
...
// pump rate = 0.5*(pump_rate_up + pump_rate_low)/(n_H2 *n_mol), pump rate is per level, pump rate of level [cm-3 s-1] = population density *loss_rate  
